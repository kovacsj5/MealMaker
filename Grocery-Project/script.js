...
class Course {// this class takes in a csv containing all data of different courses that can be put together to make meals. Based onthe link above... do I even need to make this class?
    constructor(name,inUpcoming,breakfast,lunch,dinner,protein,veggie,grainStarch,dressing,processedProtein,rawVeggie,wholeMeal,chineseStoreRequired,meijer,target,amazon,denseCooking,costLevelAssignment,timeLevelAssignment,eaten,eatenThreshold,soonestNext){
...
function PrintDay (day){
    console.log("\nBreakfast: " + day.breakfast.proteinCourse.name +" with "+ day.breakfast.veggieCourse.name + " and smoothie");
    console.log("Lunch: " + day.lunch.proteinCourse.name + " with " + day.lunch.veggieCourse.name);
    console.log("Dinner: "+ day.dinner.proteinCourse.name + " with " + day.dinner.veggieCourse.name);
}
